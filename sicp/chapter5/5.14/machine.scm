...
(define (make-new-machine)
  (let ((pc (make-register 'pc))
    ...
    (let ((the-ops
      ...
      (define (reset)
        ;(set! stack (make-stack)) ; this won't work, since assembled instructions will be using the previous stack
        (stack 'initialize)
        )
      ...
      (define (dispatch message)
        (cond ((eq? message 'start)
              ...
              ((eq? message 'print-stack-statistics) (stack 'print-statistics))
...
(define (set-register-contents! machine register-name value)
  ...
  'done)
(define (print-stack-stats machine)
...
(define (instruction? inst)
  (and (pair? inst) (symbol? (caar inst)) (procedure? (cdr inst))))
