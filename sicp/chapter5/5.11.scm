...
; special registers pc and flag don't get separate stacks
; my implementation creates a stack every time a register is allocated
; during assembling of controller text make-save and make-restore
; lookup a stack object for a particular register, so these registers
    ...
    (let ((the-ops '())
      ...
      (define (dispatch message)
        (cond ((eq? message 'start)
              ...
              ((eq? message 'get-register-stack)
               lookup-register-stack)
...
(define (make-save inst machine stack pc)
  (let ((reg (get-register machine
        ...
        (reg-stack (get-register-stack machine
                                       (stack-inst-reg-name inst))))
    (lambda ()
