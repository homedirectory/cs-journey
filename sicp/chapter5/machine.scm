          ...
          (print "regs: " 
                 (map 
                   ...
                   (filter (lambda (reg-entry)
                           ...
                           register-table))))
        (print-pc) (print-stack) (print-registers) (newline))
      ; ----- debugging -----
      (define (execute)
...
(define (make-execution-procedure
  ...
  (cond ((eq? (car inst) 'assign)
        ...
        ((eq? (car inst) 'branch)
         (make-branch #f inst machine labels flag pc))
        ((eq? (car inst) 'branch-not)
         (make-branch #t inst machine labels flag pc))
        ((eq? (car inst) 'jz)
