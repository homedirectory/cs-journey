...
; reasons that it should be a cinch to imple- ment this. He will simply feed the
; query pattern to qeval. This will produce a stream of frames. He will then
; pass this stream through a mapping function that extracts the value of the
; designated variable from each frame in the stream and feed the resulting
